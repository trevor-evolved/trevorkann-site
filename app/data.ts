...
export const CONCEPT_NODES = [
  { id: 'ling',       label: 'Linguistics',       type: 'ling',   x: 18, y: 22, size: 1.0 },
  { id: 'discourse',  label: 'Discourse',         type: 'ling',   x: 10, y: 42 },
  { id: 'framing',    label: 'Framing',           type: 'ling',   x: 8,  y: 66 },
  { id: 'register',   label: 'Register',          type: 'ling',   x: 22, y: 78 },
  { id: 'pragmatics', label: 'Pragmatics',        type: 'ling',   x: 28, y: 58 },
  { id: 'empathy',    label: 'Linguistic Empathy',type: 'ling',   x: 16, y: 12 },
  { id: 'teaching',   label: 'Teaching',          type: 'ling',   x: 30, y: 32 },
  { id: 'energy',     label: 'Energy planning',   type: 'energy', x: 82, y: 22, size: 1.0 },
  { id: 'grid',       label: 'Grid',              type: 'energy', x: 88, y: 42 },
  { id: 'decarb',     label: 'Decarbonization',   type: 'energy', x: 90, y: 66 },
  { id: 'policy',     label: 'Policy',            type: 'energy', x: 78, y: 78 },
  { id: 'model',      label: 'RIO / ENSEMBLE',    type: 'energy', x: 72, y: 58 },
  { id: 'transition', label: 'The Transition',    type: 'energy', x: 84, y: 12 },
  { id: 'utility',    label: 'Utility',           type: 'energy', x: 70, y: 32 },
  { id: 'power',      label: 'Power',             type: 'bridge', x: 50, y: 30 },
  { id: 'current',    label: 'Current',           type: 'bridge', x: 50, y: 50 },
  { id: 'capacity',   label: 'Capacity',          type: 'bridge', x: 50, y: 70 },
  { id: 'translation',label: 'Translation',       type: 'bridge', x: 40, y: 18 },
  { id: 'code',       label: 'Code',              type: 'bridge', x: 60, y: 82 },
];
